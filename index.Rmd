...
I do not believe there is any other useful county level data source than the [NY Times github](https://github.com/nytimes/covid-19-data). It is unclear where the [John Hopkins](https://github.com/CSSEGISandData/COVID-19) county data comes from and the data files that do exist have a difficult to parse format, with the [values in different columns for different dates](https://github.com/CSSEGISandData/COVID-19/blob/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_US.csv)).